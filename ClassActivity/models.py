...
class WeeklySchedule(models.Model):
    ...
    week_day = models.CharField(max_length=1,choices=week_day_choices,default=day_one)
    first_bell = models.ForeignKey(Lessons,on_delete=models.CASCADE,related_name='first_bell')   
    second_bell = models.ForeignKey(Lessons,on_delete=models.CASCADE,related_name='second_bell')   
