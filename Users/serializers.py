...
class UserDocSerializer(serializers.Serializer):
    ...
    father_nationalCode = serializers.CharField(max_length=20,allow_blank=True,allow_null=True)
    father_name = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    father_pNum = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    father_jobName = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    father_jobAddress = serializers.CharField(max_length=250,allow_null=True,allow_blank=True)
    father_job_pNum = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    father_job_postalCode = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    mother_nationalCode = serializers.CharField(max_length=20,allow_blank=True,allow_null=True)
    mother_name = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    mother_pNum = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    mother_jobName = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    mother_jobAddress = serializers.CharField(max_length=250,allow_null=True,allow_blank=True)
    mother_job_pNum = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    mother_job_postalCode = serializers.CharField(max_length=40,allow_blank=True,allow_null=True)
    ...
    section = serializers.CharField(max_length=1,allow_blank=False,allow_null=True)
...
class UserRegisterSerializer(serializers.Serializer):
    first_name = serializers.CharField(allow_null=True,allow_blank=False,max_length=20)
    last_name = serializers.CharField(allow_null=True,allow_blank=False,max_length=20)
    email = serializers.EmailField(allow_null=True,allow_blank=False,max_length=20)
    role = serializers.CharField(max_length=1,allow_blank=False,allow_null=True)
    religon = serializers.CharField(max_length=40,allow_blank=False,allow_null=True)
    userPhoto = serializers.CharField(max_length=250,allow_blank=False,allow_null=True)
    userNationalCardPhoto = serializers.CharField(max_length=250,allow_blank=False,allow_null=True)
    userIdCardPhoto = serializers.CharField(max_length=250,allow_blank=False,allow_null=True)
    user_pNum = serializers.CharField(max_length=40,allow_blank=False,allow_null=True)
    home_pNum = serializers.CharField(max_length=40,allow_blank=False,allow_null=True)
    address = serializers.CharField(max_length=250,allow_null=True,allow_blank=False)
    zipCode = serializers.CharField(max_length=20,allow_blank=False,allow_null=True)
